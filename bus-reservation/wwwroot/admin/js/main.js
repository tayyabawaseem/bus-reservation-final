...
function validatePlaces() {
    ...
    if (startingPlace && destinationPlace) {
        if (startingPlace.value === destinationPlace.value && startingPlace.value !== "") {
            ...
            markAsValid('StartingPlace');
            markAsValid('DestinationPlace');
            return true;
        }
    }
    return true;
...
function validateForm() {
    ...
    var arePlacesValid = validatePlaces();

    return isRouteNameValid && isDistanceValid && arePlacesValid;
}
